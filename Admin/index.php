...
?>
    ...
    <head>
        ...
        <title>Admin|Home - Prolearn</title>
        ...
        <div class="container mt-5">
            <div class="container text-center">
                <div class="row row-cols-5">
                    <a href="lecture.php" class="col btn btn-dark m-2 py-3">
                    ...
                    <i class="fa fa-graduation-cap fs-1" aria-hidden="true"></i><br>
                        Students
                    </a><a href="" class="col btn btn-dark m-2 py-3">
                    ...
                    <i class="fa fa-calendar fs-1" aria-hidden="true"></i><br>
                        Schedule
                    </a><a href="" class="col btn btn-primary m-2 py-3 col-5">
